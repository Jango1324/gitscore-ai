...
from gitscore.feautures.readme import extract_readme_features
def extract_profile_features(repositories):
    ...
    readme_feautures = extract_readme_features(repositories)
    combined_dict = activity_features | language_features | quality_feautures | ml_feautures | readme_feautures
